  ...
  return (
    <section className="relative min-h-[92vh] flex items-end overflow-hidden">
      <div className="absolute inset-0 z-0">
        ...
        <video
          className="absolute inset-0 w-full h-full object-cover opacity-65 animate-ken-burns"
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 pb-24 pt-32 w-full">
        <span className="inline-block text-neon-strike font-display text-lg uppercase tracking-[0.25em] mb-6 animate-fade-up">
        ...
        <div className="mt-10 flex flex-wrap gap-4 animate-fade-up" style={{ animationDelay: "1.7s" }}>
          <Link to="/players" {...ctaSoundProps} className="cta-cursor bg-neon-strike text-pitch-black px-8 py-4 font-display text-2xl uppercase tracking-wide hover:scale-[1.03] transition-transform">
            {t("home", "ctaPrimary")}
          </Link>
