...
export function CtaClose() {
  return (
    <section className="bg-[#1E2A38] text-[#F1EFE9]">
      <div className="mx-auto max-w-3xl px-6 py-24 text-center md:py-32">
        ...
        <Reveal as="p" delay={120} className="mx-auto mt-8 max-w-2xl font-sans text-lg leading-relaxed text-[#CBD3DC]">
        ...
        <Reveal as="p" delay={200} className="mx-auto mt-6 max-w-xl font-sans text-base leading-relaxed text-[#9AA6B2]">
        ...
        <Reveal delay={300} className="mt-11">
          <Link
            to="/signup"
            className="inline-flex items-center justify-center rounded-full bg-[#F5C518] px-9 py-4 font-sans text-base font-semibold text-[#1E2A38] transition-colors duration-300 hover:bg-[#E0B30F]"
          >
