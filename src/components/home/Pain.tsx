  ...
  return (
    <section className="bg-[#EFEAE0] text-[#1C1C19]">
      <div className="mx-auto max-w-3xl px-6 py-24 md:py-32">
        ...
        <Reveal as="p" delay={120} className="mt-12 font-sans text-lg leading-relaxed text-[#4A4842]">
        ...
        <Reveal as="p" delay={200} className="mt-8 font-sans text-lg leading-relaxed text-[#4A4842]">
        ...
        <Reveal as="p" delay={280} className="mt-14 font-serif text-[clamp(1.3rem,2.6vw,1.9rem)] font-medium leading-snug text-[#1E2A38]">
