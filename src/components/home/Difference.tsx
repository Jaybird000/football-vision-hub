    ...
    <section className="bg-[#1E2A38] text-[#F1EFE9]">
      <div className="mx-auto max-w-4xl px-6 py-24 md:py-36">
        <Reveal as="h2" className="font-serif text-[clamp(1.9rem,4.4vw,3.25rem)] font-medium leading-[1.1] tracking-[-0.015em]">
          ...
          <span className="text-[#F5C518]">We assess the family.</span>
        </Reveal>

        <Reveal as="p" delay={140} className="mt-10 max-w-2xl font-sans text-lg leading-relaxed text-[#C9C7BF]">
        ...
        <Reveal as="p" delay={220} className="mt-7 max-w-2xl font-sans text-lg leading-relaxed text-[#C9C7BF]">
