...
export function Credibility() {
  return (
    <section className="bg-[#EFEAE0] text-[#1C1C19]">
      <div className="mx-auto max-w-5xl px-6 py-24 md:py-32">
        ...
        <div className="mt-14 grid grid-cols-1 gap-8 sm:grid-cols-3">
          {STATS.map((s, i) => (
            <Reveal key={s.unit} delay={i * 110} className="border-t border-[#D8D1C2] pt-5">
              <div className="font-serif text-[clamp(2.5rem,6vw,3.75rem)] font-medium leading-none text-[#C99700]">
                {s.figure}
              </div>
              <div className="mt-3 font-sans text-sm uppercase tracking-[0.16em] text-[#6B6960]">
                {s.unit}
              </div>
            </Reveal>
          ))}
        ...
        <div className="mt-16 max-w-2xl space-y-6 font-sans text-lg leading-relaxed text-[#4A4842]">
          <Reveal as="p">
          ...
          <Reveal as="p" delay={180} className="font-medium text-[#1C1C19]">
